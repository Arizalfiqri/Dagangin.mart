...
<body>
    <div class="signup-container">
        ...
        <h2>Register User</h2>
        <form method="post" action="<?= base_url('customer/register/store') ?>" id="registerForm">
            <div class="form-grid">
        ...
        <p class="bottom-text">Sudah punya akun? <a href="<?= base_url('login-customer') ?>">Login</a></p>
    </div>
